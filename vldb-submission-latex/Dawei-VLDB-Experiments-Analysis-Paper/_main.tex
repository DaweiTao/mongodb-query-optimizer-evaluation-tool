...
\begin{document}
\title{First Past the Post: Evaluating Query Optimization in MongoDB}%\\
%{\normalfont [Experiments, Analysis and Benchmarks]}}
...
\email{michael.cahill@mongodb.com}
...
\input{4-measuring-effectiveness_and_impact.tex}
\input{5-root-cause-analysis.tex}
\input{6-conclusions.tex}
% \input{extra-experiment.tex}
...
%\appendix
%\input{figures-with-explanations.tex}
%\input{effect-of-caching.tex}
